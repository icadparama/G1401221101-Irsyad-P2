...
Data yang digunakan dalam kesempatan kali ini adalah data GDP Negara Middle east dan North Africa periode tahun 1965-2023.
...
Sebelum melakukan regresi, akan diperlihatkan *plot time-series* dari data GDP Middle East dan North Africa periode tahun 1960-2023
...
$$GDP= −(395510e+14) + (1.204149e+11) ×Tahun$$
...
```{r}
#Transformasi Manual
GDP.trans<- data$GDP[-1]-data$GDP[-64]*rho
Tahun.trans<- data$Tahun[-1]-data$Tahun[-64]*rho
...
Berdasarkan hasil tersebut dapat diketahui bahwa hasil penanganan autokorelasi dengan metode Cochrane-Orcutt dan Hildreth-Lu memiliki SSE yang yang berbeda, sebesar $2.243685e+24$ dan $2.180396e+24$ lebih baik dibandingkan model awal ketika autokorelasi masih terjadi, yaitu sebesar $1.852648e+25 $.
